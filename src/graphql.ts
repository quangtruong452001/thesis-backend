...
export abstract class IQuery {
  ...
  abstract userReservations():
    | Nullable<Reservation>[]
    | Promise<Nullable<Reservation>[]>;
  ...
  abstract staffs():
    | Nullable<Nullable<Staff>[]>
    | Promise<Nullable<Nullable<Staff>[]>>;
